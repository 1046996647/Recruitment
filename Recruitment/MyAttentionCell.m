...
//        _imgView.backgroundColor = [UIColor redColor];
        ...
        _jobLab = [UILabel labelWithframe:CGRectMake(_companyLab.left, _companyLab.bottom+8, _companyLab.width, 18) text:@"饰品抛光" font:[UIFont systemFontOfSize:13] textAlignment:NSTextAlignmentLeft textColor:@"#666666"];
        ...
        // 150人
//        _personsLab = [UILabel labelWithframe:CGRectMake(_companyLab.left, _jobLab.bottom+8, _timeLab.left-(_imgView.right+12)-10, 18) text:@"" font:[UIFont systemFontOfSize:13] textAlignment:NSTextAlignmentLeft textColor:@"#666666"];
